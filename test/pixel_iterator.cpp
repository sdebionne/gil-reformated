...
void test_pixel_iterator() {
  ...
  boost::function_requires<MutablePixelLocatorConcept<
      byte_addressable_2d_locator<rgb8_step_ptr_t>>>();
...
void test_pixel_iterator() {
    ...
    const rgb8_pixel_t& ref=byte_advanced_ref(ptr1,10);
...
//  bool
v=boost::is_POD<iterator_traits<byte_addressable_step_iterator<rgb8_ptr_t>
>::value_type>::value;
...
const iterator typedef iterator_from_2d<rgb8_loc_t>::difference_type dif_t;
    ...
    //  byte_addressable_step_iterator<rgb8_pixel_t> stepIt3Err=stepIt+10; //
