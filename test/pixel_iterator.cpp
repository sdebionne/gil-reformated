...
void test_pixel_iterator() {
  ...
  typedef dereference_iterator_adaptor<rgb8_step_ptr_t, ccv_rgb_g_fn>
      rgb2gray_step_ptr1;
  ...
  typedef const bit_aligned_pixel_reference<
      boost::mpl::vector3_c<unsigned, 2, 3, 2>, bgr_layout_t, true>
      bgr232_ref_t;
...
//  bool v=boost::is_POD<iterator_traits<memory_based_step_iterator<rgb8_ptr_t>
>::value_type>::value;
...
//  typedef const iterator_traits<rgb8_planar_ptr_t>::pointer
RGB8ConstPlanarPtr;
