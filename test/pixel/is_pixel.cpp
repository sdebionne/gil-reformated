...
int main() {
  static_assert(
      std::is_same<mp_all_of<gil::test::fixture::pixel_typedefs, gil::is_pixel>,
                   std::true_type>::value,
  ...
  static_assert(
      std::is_same<
          mp_all_of<
              mp_transform<gil::test::fixture::nested_pixel_type,
  ...
  static_assert(
      std::is_same<mp_all_of<gil::test::fixture::non_pixels, gil::is_pixel>,
                   std::false_type>::value,
      "is_pixel yields true for non-pixel type");

  static_assert(
      std::is_same<mp_none_of<gil::test::fixture::non_pixels, gil::is_pixel>,
                   std::true_type>::value,
      "is_pixel yields true for non-pixel type");

  using bgr121_ref_t =
      gil::bit_aligned_pixel_reference<std::uint8_t, mp_list_c<int, 1, 2, 1>,
                                       gil::bgr_layout_t, true>;
  static_assert(gil::is_pixel<bgr121_ref_t>::value,
                "is_pixel does not yield true for bit_aligned_pixel_reference");

  using rgb121_ref_t =
      gil::bit_aligned_pixel_reference<std::uint8_t, mp_list_c<int, 1, 2, 1>,
                                       gil::rgb_layout_t, true>;
  static_assert(gil::is_pixel<bgr121_ref_t>::value,
                "is_pixel does not yield true for bit_aligned_pixel_reference");
