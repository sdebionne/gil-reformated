...
operator<<(std::ostream &os,
           gil::packed_pixel<BitField, ChannelRefs, Layout> const &p) {
  os << "packed_pixel<"
...
using packed_channel_references_3 =
    typename gil::detail::packed_channel_references_vector_type<
        std::uint8_t, mpl::vector1_c<int, 3>>::type;
...
BOOST_AUTO_TEST_CASE(packed_pixel_gray3_definition) {
  ...
  static_assert(
      std::is_same<packed_pixel_gray3::layout_t, gil::gray_layout_t>::value,
      "layout should be bgr");

  static_assert(
      std::is_same<packed_pixel_gray3::value_type, packed_pixel_gray3>::value,
      "value_type member should be of the same type as the packed_pixel "
      "specialization");
  ...
  static_assert(std::is_same<decltype(packed_pixel_gray3::is_mutable),
                             bool const>::value &&
  ...
  static_assert(
      std::is_same<gil::detail::packed_channel_reference_type<
                       std::uint8_t, mpl::int_<0>, mpl::int_<3>>::type,
                   channel1_ref_t>::value,
      "packed_channel_reference_type should return packed_channel_reference");
  static_assert(
      std::is_same<
          gil::detail::packed_channel_reference_type<std::uint8_t, mpl::int_<0>,
                                                     mpl::int_<3>>::type,
...
using packed_channel_references_121 =
    typename gil::detail::packed_channel_references_vector_type<
        std::uint8_t, mpl::vector3_c<int, 1, 2, 1>>::type;
...
BOOST_AUTO_TEST_CASE(packed_pixel_bgr121_definition) {
  ...
  static_assert(
      std::is_same<packed_pixel_bgr121::layout_t, gil::bgr_layout_t>::value,
      "layout should be bgr");

  static_assert(
      std::is_same<packed_pixel_bgr121::value_type, packed_pixel_bgr121>::value,
      "value_type member should be of the same type as the packed_pixel "
      "specialization");
  ...
  static_assert(std::is_same<decltype(packed_pixel_bgr121::is_mutable),
                             bool const>::value &&
  ...
  static_assert(
      std::is_same<gil::detail::packed_channel_reference_type<
                       std::uint8_t, mpl::int_<0>, mpl::int_<1>>::type,
                   channel1_ref_t>::value,
      "packed_channel_reference_type should return packed_channel_reference");
  static_assert(
      std::is_same<
...
using packed_channel_references_535 =
    typename gil::detail::packed_channel_references_vector_type<
        std::uint16_t, mpl::vector3_c<int, 5, 3, 5>>::type;
...
BOOST_AUTO_TEST_CASE(packed_pixel_rgb535_definition) {
  ...
  static_assert(
      std::is_same<packed_pixel_rgb535::layout_t, gil::rgb_layout_t>::value,
      "layout should be bgr");

  static_assert(
      std::is_same<packed_pixel_rgb535::value_type, packed_pixel_rgb535>::value,
      "value_type member should be of the same type as the packed_pixel "
      "specialization");
  ...
  static_assert(std::is_same<decltype(packed_pixel_rgb535::is_mutable),
                             bool const>::value &&
  ...
  static_assert(
      std::is_same<gil::detail::packed_channel_reference_type<
                       std::uint16_t, mpl::int_<0>, mpl::int_<5>>::type,
                   channel1_ref_t>::value,
      "packed_channel_reference_type should return packed_channel_reference");
  static_assert(
      std::is_same<gil::detail::packed_channel_reference_type<
