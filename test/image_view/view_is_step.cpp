...
template <typename View> void test_view_is_step_in_xy() {
  static_assert(gil::view_is_step_in_x<View>::value,
                "view should support horizontal step");
  static_assert(gil::view_is_step_in_y<View>::value,
                "view should support vertical step");
}

template <typename View> void test_view_is_step_in_y() {
  static_assert(gil::view_is_step_in_y<View>::value,
                "view should support vertical step");
}

template <typename View> void test_view_is_step_in_x_not() {
  static_assert(!gil::view_is_step_in_x<View>::value,
                "view should not support horizontal step");
}
