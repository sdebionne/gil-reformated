...
// FIXME: Range as pixel does not seem to fulfill pixel concepts due to no
// specializations required:
//        pixel.hpp(50) : error C2039 : 'type' : is not a member of
//        'boost::gil::color_space_type<P>
...
using array_pixel_types =
    ::boost::mp11::mp_list<boost::array<int, 2>, std::array<int, 2>>;
