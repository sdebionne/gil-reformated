...
BOOST_AUTO_TEST_CASE_TEMPLATE(fill_with_pixel_integer_types, Pixel,
...
BOOST_AUTO_TEST_CASE_TEMPLATE(fill_with_pixel_float_types, Pixel,
                              fixture::pixel_float_types) {
  auto min_pixel = fixture::pixel_generator<Pixel>::min();
  auto max_pixel = fixture::pixel_generator<Pixel>::max();
...
BOOST_AUTO_TEST_CASE(fill_with_packed_pixel_gray3) {
  ...
  for (auto const &fill_pixel : {min_pixel, max_pixel, mid_pixel}) {
    ...
    for (fixture::packed_pixel_gray3 const &p : pixels) {
      BOOST_TEST(p == fill_pixel);
      BOOST_TEST((int)get_color(p, gil::gray_color_t()) ==
...
BOOST_AUTO_TEST_CASE(fill_with_packed_pixel_bgr121) {
  ...
  for (auto const &fill_pixel : {min_pixel, max_pixel, mid_pixel}) {
    ...
    for (fixture::packed_pixel_bgr121 const &p : pixels) {
      BOOST_TEST(p == fill_pixel);
      BOOST_TEST((int)get_color(p, gil::red_t()) ==
                 (int)get_color(fill_pixel, gil::red_t()));
      BOOST_TEST((int)get_color(p, gil::green_t()) ==
                 (int)get_color(fill_pixel, gil::green_t()));
      BOOST_TEST((int)get_color(p, gil::blue_t()) ==
