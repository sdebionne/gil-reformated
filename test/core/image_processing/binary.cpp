...
int main() {
  ...
  /*-----------------------Threshold Binary with
   * inverse----------------------------*/

  // expected view after thresholding of the original view with threshold value
  // of 100 filling expected view's upper half part with gray pixels of value 200
  ...
  gil::threshold_binary(gil::view(original), gil::view(threshold), 100, 200,
