...
void fill_original_rgb() {
  ...
  // 85, 135 filling original_rgb view's lower half part with rgb pixels of value
  // 150, 205, 106
...
void threshold_gray_to_gray() {
  ...
  gil::threshold_truncate(gil::view(original_gray), gil::view(threshold_gray),
                          100);
...
void threshold_inverse_gray_to_gray() {
  // expected view after thresholding of the original view with threshold value
  // of 100 filling expected view's upper half part with gray pixels of value 100
  ...
  gil::threshold_truncate(gil::view(original_gray), gil::view(threshold_gray),
                          100, gil::threshold_truncate_mode::threshold,
...
void threshold_rgb_to_rgb() {
  // expected view after thresholding of the original view with threshold value
  // of 100 filling expected_rgb view's upper half part with rgb pixels of value
  // 50 filling expected_rgb view's lower half part with rgb pixels of value 100
  ...
  gil::threshold_truncate(gil::view(original_rgb), gil::view(threshold_rgb),
                          100);
...
void threshold_inverse_rgb_to_rgb() {
  // expected view after thresholding of the original view with threshold value
  // of 100 filling expected_rgb view's upper half part with rgb pixels of value
  // 103, 59, 246 filling expected_rgb view's lower half part with rgb pixels of
  // value 150
  gil::fill_pixels(gil::subimage_view(gil::view(expected_rgb), 0, 0,
                                      original_rgb.width(),
                                      original_rgb.height() / 2),
...
void zero_rgb_to_rgb() {
  // expected view after thresholding of the original view with threshold value
  // of 100 filling expected_rgb view's upper half part with rgb pixels of value
  // 0 filling expected_rgb view's lower half part with rgb pixels of value 150
  gil::fill_pixels(gil::subimage_view(gil::view(expected_rgb), 0, 0,
                                      original_rgb.width(),
                                      original_rgb.height() / 2),
...
void zero_inverse_rgb_to_rgb() {
  // expected view after thresholding of the original view with threshold value
  // of 100 filling expected_rgb view's upper half part with rgb pixels of value
  // 50 filling expected_rgb view's lower half part with rgb pixels of value 0
  gil::fill_pixels(gil::subimage_view(gil::view(expected_rgb), 0, 0,
                                      original_rgb.width(),
                                      original_rgb.height() / 2),
