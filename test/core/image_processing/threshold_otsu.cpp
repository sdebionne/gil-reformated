...
gil::rgb8_image_t original_rgb(width, height), otsu_rgb(width, height),
...
void test_gray_regular() {
  ...
  gil::threshold_optimal(gil::view(original_gray), gil::view(otsu_gray),
...
void test_rgb_regular() {
  ...
  gil::threshold_optimal(gil::view(original_rgb), gil::view(otsu_rgb),
                         gil::threshold_optimal_value::otsu);
