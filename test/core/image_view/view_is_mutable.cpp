...
template <typename View> void test_view_is_mutable() {
  static_assert(gil::view_is_mutable<View>::value, "view should be mutable");
}

template <typename View> void test_view_is_mutable_not() {
  static_assert(!gil::view_is_mutable<View>::value,
                "view should not be mutable");
}
