...
template <typename Pixel> struct pixel_generator {
...
using pixel_integer_types = ::boost::mp11::mp_list<
    ...
    gil::bgr8_pixel_t, gil::bgr8s_pixel_t, gil::bgr16_pixel_t,
    gil::bgr16s_pixel_t, gil::bgr32_pixel_t, gil::bgr32s_pixel_t,
    gil::rgb8_pixel_t, gil::rgb8s_pixel_t, gil::rgb16_pixel_t,
    gil::rgb16s_pixel_t, gil::rgb32_pixel_t, gil::rgb32s_pixel_t,
    gil::abgr8_pixel_t, gil::abgr8s_pixel_t, gil::abgr16_pixel_t,
    gil::abgr16s_pixel_t, gil::abgr32_pixel_t, gil::abgr32s_pixel_t,
    gil::bgra8_pixel_t, gil::bgra8s_pixel_t, gil::bgra16_pixel_t,
    gil::bgra16s_pixel_t, gil::bgra32_pixel_t, gil::bgra32s_pixel_t,
    gil::cmyk8_pixel_t, gil::cmyk8s_pixel_t, gil::cmyk16_pixel_t,
    gil::cmyk16s_pixel_t, gil::cmyk32_pixel_t, gil::cmyk32s_pixel_t,
    gil::rgba8_pixel_t, gil::rgba8s_pixel_t, gil::rgba16_pixel_t,
    gil::rgba16s_pixel_t, gil::rgba32_pixel_t, gil::rgba32s_pixel_t>;

// List of all integer-based core pixel typedefs (i.e. with cv-qualifiers)
using pixel_float_types =
    ::boost::mp11::mp_list<gil::gray32f_pixel_t, gil::bgr32f_pixel_t,
                           gil::rgb32f_pixel_t, gil::abgr32f_pixel_t,
                           gil::bgra32f_pixel_t, gil::cmyk32f_pixel_t,
                           gil::rgba32f_pixel_t>;

// List of all core pixel types (i.e. without cv-qualifiers)
using pixel_types =
    ::boost::mp11::mp_append<pixel_integer_types, pixel_float_types>;

// List of all core pixel typedefs (i.e. with cv-qualifiers)
using pixel_typedefs = ::boost::mp11::mp_append<
    pixel_integer_types, pixel_float_types,
    ::boost::mp11::mp_list<
        gil::gray8c_pixel_t, gil::gray8sc_pixel_t, gil::gray16c_pixel_t,
        gil::gray16sc_pixel_t, gil::gray32c_pixel_t, gil::gray32fc_pixel_t,
        gil::gray32sc_pixel_t, gil::bgr8c_pixel_t, gil::bgr8sc_pixel_t,
        gil::bgr16c_pixel_t, gil::bgr16sc_pixel_t, gil::bgr32c_pixel_t,
        gil::bgr32fc_pixel_t, gil::bgr32sc_pixel_t, gil::rgb8c_pixel_t,
        gil::rgb8sc_pixel_t, gil::rgb16c_pixel_t, gil::rgb16sc_pixel_t,
        gil::rgb32c_pixel_t, gil::rgb32fc_pixel_t, gil::rgb32sc_pixel_t,
        gil::abgr8c_pixel_t, gil::abgr8sc_pixel_t, gil::abgr16c_pixel_t,
        gil::abgr16sc_pixel_t, gil::abgr32c_pixel_t, gil::abgr32fc_pixel_t,
        gil::abgr32sc_pixel_t, gil::bgra8c_pixel_t, gil::bgra8sc_pixel_t,
        gil::bgra16c_pixel_t, gil::bgra16sc_pixel_t, gil::bgra32c_pixel_t,
        gil::bgra32fc_pixel_t, gil::bgra32sc_pixel_t, gil::cmyk8c_pixel_t,
        gil::cmyk8sc_pixel_t, gil::cmyk16c_pixel_t, gil::cmyk16sc_pixel_t,
        gil::cmyk32c_pixel_t, gil::cmyk32fc_pixel_t, gil::cmyk32sc_pixel_t,
        gil::rgba8c_pixel_t, gil::rgba8sc_pixel_t, gil::rgba16c_pixel_t,
        gil::rgba16sc_pixel_t, gil::rgba32c_pixel_t, gil::rgba32fc_pixel_t,
...
using packed_channel_references_3 =
    typename gil::detail::packed_channel_references_vector_type<
        std::uint8_t, mp11::mp_list_c<int, 3>>::type;

using packed_pixel_gray3 =
    gil::packed_pixel<std::uint8_t, packed_channel_references_3,
                      gil::gray_layout_t>;

using packed_channel_references_121 =
    typename gil::detail::packed_channel_references_vector_type<
        std::uint8_t, mp11::mp_list_c<int, 1, 2, 1>>::type;

using packed_pixel_bgr121 =
    gil::packed_pixel<std::uint8_t, packed_channel_references_121,
                      gil::bgr_layout_t>;

using packed_channel_references_535 =
    typename gil::detail::packed_channel_references_vector_type<
        std::uint16_t, mp11::mp_list_c<int, 5, 3, 5>>::type;

using packed_pixel_rgb535 =
    gil::packed_pixel<std::uint16_t, packed_channel_references_535,
                      gil::rgb_layout_t>;

using bit_aligned_pixel_bgr232_refefence = gil::bit_aligned_pixel_reference<
    std::uint8_t, mp11::mp_list_c<int, 2, 3, 2>, gil::bgr_layout_t, true> const;
...
using bit_aligned_pixel_rgb567_refefence =
    gil::bit_aligned_pixel_reference<std::uint32_t,
                                     mp11::mp_list_c<int, 5, 6, 7>,
                                     gil::rgb_layout_t, true> const;
