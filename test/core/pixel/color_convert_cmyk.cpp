...
template <typename SrcPixel> struct test_cmyk_from_gray {
  template <typename DstPixel> void operator()(DstPixel const &) {
...
struct test_cmyk_from_rgb {
  ...
  static void run() {
    boost::mp11::mp_for_each<mp11::mp_product<
        mp11::mp_list,
        mp11::mp_list<gil::rgb8_pixel_t, gil::rgb8s_pixel_t, gil::rgb16_pixel_t,
                      gil::rgb16s_pixel_t, gil::rgb32_pixel_t,
                      gil::rgb32s_pixel_t, gil::rgb32f_pixel_t>,
        mp11::mp_list<gil::cmyk8_pixel_t, gil::cmyk16_pixel_t,
                      gil::cmyk32_pixel_t, gil::cmyk32f_pixel_t
                      // FIXME: Conversion not handle properly signed CMYK
