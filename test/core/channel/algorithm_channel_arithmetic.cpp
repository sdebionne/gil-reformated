...
#define BOOST_TEST_MODULE                                                      \
  gil / test / core / channel / algorithm_channel_arithmetic
...
template <typename ChannelFixtureBase> void test_channel_arithmetic() {
  using fixture_t = fixture::channel<ChannelFixtureBase>;
  fixture_t f;
  ...
  using is_mutable_t = std::integral_constant<
      bool, gil::channel_traits<typename fixture_t::channel_t>::is_mutable>;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(packed_channel_reference, BitField,
...
BOOST_AUTO_TEST_CASE_TEMPLATE(packed_dynamic_channel_reference, BitField,
                              fixture::channel_bitfield_types) {
