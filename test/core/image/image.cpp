...
struct test_constructor_with_dimensions_pixel {
  ...
  static void run() {
    boost::mp11::mp_for_each<fixture::image_types>(
        test_constructor_with_dimensions_pixel{});
  }
};
...
struct test_move_constructor {
  template <typename Image> void operator()(Image const &) {
    ...
    {
      image_t image(
          fixture::create_image<image_t>(dimensions.x, dimensions.y, 0));
  ...
  template <typename Image> void operator()(Image const &) {
    ...
    gil::point_t const dimensions{256, 128};
    {
      image_t image =
          fixture::create_image<image_t>(dimensions.x, dimensions.y, 0);
      image_t image2 =
          fixture::create_image<image_t>(dimensions.x * 2, dimensions.y * 2, 1);
