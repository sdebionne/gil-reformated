...
template <typename Locator> void test_immutable() {
...
template <typename Locator> void test_mutable() {
  function_requires<gil::MutablePixelLocatorConcept<Locator>>();
  function_requires<gil::HasDynamicXStepTypeConcept<Locator>>();
  function_requires<gil::HasDynamicYStepTypeConcept<Locator>>();
}

template <typename Pixel> struct archetype_pixel_dereference {
...
using virtual_locator =
    gil::virtual_2d_locator<archetype_pixel_dereference<Pixel>, false>;
