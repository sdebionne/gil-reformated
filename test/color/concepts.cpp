...
int main() {
  ...
  function_requires<
      gil::ColorSpacesCompatibleConcept<gil::gray_t, gil::gray_t>>();
  function_requires<
      gil::ColorSpacesCompatibleConcept<gil::cmyk_t, gil::cmyk_t>>();
  function_requires<
      gil::ColorSpacesCompatibleConcept<gil::rgb_t, gil::rgb_t>>();
  function_requires<
      gil::ColorSpacesCompatibleConcept<gil::rgba_t, gil::rgba_t>>();
  function_requires<gil::ColorSpacesCompatibleConcept<gil::devicen_t<2>,
                                                      gil::devicen_t<2>>>();
}
