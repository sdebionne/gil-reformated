...
// big/expensive.
typedef mpl::vector<value_core<gray8_pixel_t>, reference_core<gray16_pixel_t &>,
...
template <typename Pixel1> struct ccv2 {
  ...
  template <typename Pixel2> void operator()(Pixel2) {
    ...
    typedef typename boost::remove_reference<typename Pixel2::type>::type
        pixel_model_t;
...
void test_packed_pixel() {
  ...
  typedef packed_pixel_type<uint16_t, mpl::vector3_c<unsigned, 5, 6, 5>,
                            bgr_layout_t>::type bgr556_pixel_t;
  ...
  typedef const bit_aligned_pixel_reference<
      ...
      bgr121_ref_t;
  typedef const bit_aligned_pixel_reference<
      boost::uint8_t, boost::mpl::vector3_c<int, 1, 2, 1>, rgb_layout_t, true>
      rgb121_ref_t;
...
BOOST_AUTO_TEST_CASE(pixel_test) { test_pixel(); }
