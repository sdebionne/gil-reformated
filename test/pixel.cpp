...
void test_packed_pixel() {
  ...
  typedef heterogeneous_packed_pixel<
      uint16_t,
      mpl::vector3<bgr556_channel0_t, bgr556_channel1_t, bgr556_channel2_t>,
      bgr_layout_t>
      bgr556_pixel_t;
  boost::function_requires<PixelValueConcept<rgb565_pixel_t>>();
  ...
  get_color(r565, red_t()) =
      channel_convert<rgb565_channel0_t>(get_color(rgb_full, red_t()));
  get_color(r565, green_t()) =
      channel_convert<rgb565_channel1_t>(get_color(rgb_full, green_t()));
  get_color(r565, blue_t()) =
      channel_convert<rgb565_channel2_t>(get_color(rgb_full, blue_t()));
