...
#define RGB_VIEW(T)                                                            \
  image_view<byte_addressable_2d_locator<                                      \
      byte_addressable_step_iterator<pixel<T, rgb_layout_t> *>>>
#define BGR_VIEW(T)                                                            \
  image_view<byte_addressable_2d_locator<                                      \
      byte_addressable_step_iterator<pixel<T, bgr_layout_t> *>>>
#define RGB_PLANAR_VIEW(T)                                                     \
  image_view<byte_addressable_2d_locator<                                      \
      byte_addressable_step_iterator<planar_pixel_iterator<T *, rgb_t>>>>
...
void test_transform(std::size_t trials) {
  ...
  std::cout << "GIL: "
            << measure_time(
                   transform_gil_t<View1, View2, F>(view(im1), view(im2), F()),
                   trials)
            << std::endl;
  std::cout << "Non-GIL: "
            << measure_time(transform_nongil_t<View1, View2, F>(view(im1),
                                                                view(im2), F()),
                            trials)
            << std::endl;
}
