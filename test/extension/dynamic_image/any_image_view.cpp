...
void test_any_image_view_nested_types() {
  BOOST_TEST_TRAIT_SAME(gil::any_image_view<gil::gray8_view_t>::const_t,
                        gil::any_image_view<gil::gray8c_view_t>);
}
...
struct test_any_image_view_assign_operator {
  ...
  static void run() {
    boost::mp11::mp_for_each<fixture::image_types>(
        test_any_image_view_assign_operator{});
  }
};
