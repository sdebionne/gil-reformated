...
BOOST_AUTO_TEST_CASE_TEMPLATE(subimage_equals_image, Image,
                              fixture::image_types) {
  ...
  {
    auto v1 = gil::subimage_view(gil::view(i0), 0, 0, i0.dimensions().x,
                                 i0.dimensions().y);
    BOOST_TEST(v0.dimensions() == v1.dimensions());
    BOOST_TEST(v0.size() == v1.size());
    BOOST_TEST(gil::equal_pixels(v0, v1));
...
BOOST_AUTO_TEST_CASE_TEMPLATE(subimage_equals_image_quadrants, Image,
                              fixture::image_types) {
  ...
  gil::apply_operation(
      v0, fixture::fill_any_view<Image>({2, 3, 6, 7}, gil::const_view(i1)[0]));
  //  quadrant 2
  auto const i2 = fixture::create_image<Image>(2, 2, 128);
  gil::apply_operation(
      v0, fixture::fill_any_view<Image>({0, 1, 4, 5}, gil::const_view(i2)[0]));
  //  quadrant 3
  auto const i3 = fixture::create_image<Image>(2, 2, 64);
  gil::apply_operation(v0, fixture::fill_any_view<Image>(
                               {8, 9, 12, 13}, gil::const_view(i3)[0]));
  //  quadrant 4
  auto const i4 = fixture::create_image<Image>(2, 2, 32);
  gil::apply_operation(v0, fixture::fill_any_view<Image>(
                               {10, 11, 14, 15}, gil::const_view(i4)[0]));
