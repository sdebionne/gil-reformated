...
#define BOOST_TEST_MODULE                                                      \
  gil / test / extension / numeric / pixel_numeric_operations
...
BOOST_AUTO_TEST_CASE_TEMPLATE(plus_integer_same_types, pixel_t,
  ...
  {
    // Generates pixels with consecutive channel values: {1} or {1,2,3} or
    // {1,2,3,4} etc.
...
BOOST_AUTO_TEST_CASE_TEMPLATE(minus_integer_same_types, pixel_t,
                              fixture::pixel_integer_types) {
  using channel_t = typename gil::channel_type<pixel_t>::type;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(pixel_multiplies_scalar_integer_same_types,
                              pixel_t, fixture::pixel_integer_types) {
  using channel_t = typename gil::channel_type<pixel_t>::type;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(pixel_multiply_integer_same_types, pixel_t,
                              fixture::pixel_integer_types) {
  using channel_t = typename gil::channel_type<pixel_t>::type;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(pixel_divides_scalar_integer_same_types, pixel_t,
                              fixture::pixel_integer_types) {
  using channel_t = typename gil::channel_type<pixel_t>::type;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(pixel_divide_integer_same_types, pixel_t,
                              fixture::pixel_integer_types) {
  using channel_t = typename gil::channel_type<pixel_t>::type;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(pixel_halves_integer_same_types, pixel_t,
                              fixture::pixel_integer_types) {
  using channel_t = typename gil::channel_type<pixel_t>::type;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(pixel_zeros_integer_same_types, pixel_t,
                              fixture::pixel_integer_types) {
  using channel_t = typename gil::channel_type<pixel_t>::type;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(zero_channels_integer_same_types, pixel_t,
                              fixture::pixel_integer_types) {
  using channel_t = typename gil::channel_type<pixel_t>::type;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(pixel_assigns_integer_same_types, pixel_t,
                              fixture::pixel_integer_types) {
  using channel_t = typename gil::channel_type<pixel_t>::type;
