...
struct test_minus_integer_mixed_types {
  ...
  static void run() {
    boost::mp11::mp_for_each<fixture::channel_integer_types>(
        test_minus_integer_mixed_types{});
  }
};
...
struct test_divides_integer_same_types {
  ...
  static void run() {
    boost::mp11::mp_for_each<fixture::channel_integer_types>(
        test_divides_integer_same_types{});
  }
};
...
struct test_halves_integer_same_types {
  ...
  static void run() {
    boost::mp11::mp_for_each<fixture::channel_integer_types>(
        test_halves_integer_same_types{});
  }
};
...
struct test_assigns_integer_same_types {
  ...
  static void run() {
    boost::mp11::mp_for_each<fixture::channel_integer_types>(
        test_assigns_integer_same_types{});
  }
};
