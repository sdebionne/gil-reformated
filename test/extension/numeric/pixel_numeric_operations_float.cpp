...
void test_plus() {
  ...
  gil::pixel_plus_t<gil::rgb8_pixel_t, gil::bgr8_pixel_t, gil::bgr8_pixel_t>
      op2;
...
void test_multiply() {
  ...
  gil::pixel_multiply_t<gil::rgb32f_pixel_t, gil::bgr32f_pixel_t,
                        gil::rgb32f_pixel_t>
      op;
...
void test_divide() {
  // integer
  {
    ...
    gil::pixel_divide_t<gil::rgb8_pixel_t, gil::bgr8_pixel_t, gil::rgb8_pixel_t>
        op;
    gil::rgb32f_pixel_t c = op(a, b);
  ...
  // float
  {
    ...
    gil::pixel_divide_t<gil::rgb32f_pixel_t, gil::bgr32f_pixel_t,
                        gil::rgb32f_pixel_t>
        op;
    gil::rgb32f_pixel_t c = op(a, b);
