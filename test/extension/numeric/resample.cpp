...
template <class F, class I> struct test_map_fn {
...
template <class F, class I> struct mapping_traits<test_map_fn<F, I>> {
...
void test_bilinear_sampler_test() {
  ...
  gil::resample_pixels(gil::const_view(img), gil::view(dims), mf,
