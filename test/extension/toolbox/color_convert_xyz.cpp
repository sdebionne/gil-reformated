...
void test_xyz32f_rgb32f_1() {
  ...
  BOOST_GIL_TEST_DEBUG_OSTREAM
      << xyz32f[0] << " " << xyz32f[1] << " " << xyz32f[2] << " -> " << p32f[0]
...
void test_rgb8u_xyz32f_1() {
  ...
  BOOST_GIL_TEST_DEBUG_OSTREAM
      << static_cast<int>(p8u[0]) << " " << static_cast<int>(p8u[1]) << " "
      << static_cast<int>(p8u[2]) << " -> " << xyz32f[0] << " " << xyz32f[1]
      << " " << xyz32f[2] << " -> " << static_cast<int>(p8u_b[0]) << " "
      << static_cast<int>(p8u_b[1]) << " " << static_cast<int>(p8u_b[2])
      << '\n';
...
void test_rgb16u_xyz32f_1() {
  ...
  BOOST_GIL_TEST_DEBUG_OSTREAM
      << static_cast<int>(p16u[0]) << " " << static_cast<int>(p16u[1]) << " "
      << static_cast<int>(p16u[2]) << " -> " << xyz32f[0] << " " << xyz32f[1]
      << " " << xyz32f[2] << " -> " << static_cast<int>(p16u_b[0]) << " "
      << static_cast<int>(p16u_b[1]) << " " << static_cast<int>(p16u_b[2])
      << '\n';
