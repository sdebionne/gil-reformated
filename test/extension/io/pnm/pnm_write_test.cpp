...
void test_write() {
  mandel_view<gil::rgb8_pixel_t>::type v = create_mandel_view(
      200, 200, gil::rgb8_pixel_t(0, 0, 255), gil::rgb8_pixel_t(0, 255, 0));
  ...
  // test writing all supported image types
  {
    ...
    gil::write_view(pnm_out + "p4_write_test.pnm", gil::view(dst),
                    gil::pnm_tag());
  }
  {
    ...
    gil::write_view(pnm_out + "p5_write_test.pnm", gil::view(dst),
                    gil::pnm_tag());
  }
...
void test_rgb_color_space_write() {
  color_space_write_test<gil::pnm_tag>(pnm_out + "rgb_color_space_test.pnm",
