...
void test_write_gray8() {
  gil::write_view(jpeg_out + "gray8_test.jpg",
                  create_mandel_view(200, 200, gil::gray8_pixel_t(0),
                                     gil::gray8_pixel_t(255)),
                  gil::jpeg_tag());
}

void test_write_rgb8() {
  gil::write_view(jpeg_out + "rgb8_test.jpg",
...
void test_write_cmyk8() {
  gil::write_view(jpeg_out + "cmyk8_test.jpg",
                  create_mandel_view(200, 200,
                                     gil::cmyk8_pixel_t(0, 0, 255, 127),
                                     gil::cmyk8_pixel_t(0, 255, 0, 127)),
                  gil::jpeg_tag());
}
...
void test_rgb_color_space_write_test() {
  color_space_write_test<gil::jpeg_tag>(jpeg_out + "rgb_color_space_test.jpg",
