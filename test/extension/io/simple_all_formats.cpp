...
void test_bmp() {
  ...
  gil::write_view(bmp_out + "all_formats_test.bmp", gil::view(img),
                  gil::bmp_tag());
...
void test_jpeg() {
  ...
  gil::write_view(jpeg_out + "all_formats_test.jpg", gil::view(img),
                  gil::jpeg_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
}
...
void test_png() {
  ...
  gil::write_view(png_out + "all_formats_test.png", gil::view(img),
                  gil::png_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
}
...
void test_pnm() {
  ...
  gil::write_view(pnm_out + "all_formats_test.pnm", gil::view(img),
                  gil::pnm_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
}
...
void test_targa() {
  ...
  gil::write_view(targa_out + "all_formats_test.tga", gil::view(img),
                  gil::targa_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
}
...
void test_tiff() {
  ...
  gil::write_view(tiff_out + "all_formats_test.tif", gil::view(img),
                  gil::tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
}
