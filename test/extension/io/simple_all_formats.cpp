...
void test_bmp() {
  ...
  gil::write_view(bmp_out + "simple_all_format.bmp", gil::view(img),
                  gil::bmp_tag());
}
...
void test_jpeg() {
  ...
  gil::write_view(jpeg_out + "simple_all_format.jpg", gil::view(img),
                  gil::jpeg_tag());
}
...
void test_png() {
  ...
  gil::write_view(png_out + "simple_all_format.png", gil::view(img),
                  gil::png_tag());
}
...
void test_pnm() {
  ...
  gil::write_view(pnm_out + "simple_all_format.pnm", gil::view(img),
                  gil::pnm_tag());
}
...
void test_targa() {
  ...
  gil::write_view(targa_out + "simple_all_format.tga", gil::view(img),
                  gil::targa_tag());
}
...
void test_tiff() {
  ...
  gil::write_view(tiff_out + "simple_all_format.tif", gil::view(img),
                  gil::tiff_tag());
}
