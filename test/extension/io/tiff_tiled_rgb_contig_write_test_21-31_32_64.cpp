...
BOOST_AUTO_TEST_CASE(write_tile_and_compare_with_rgb_strip_contig_32) {
  ...
  write_view(tiff_out + "write_tile_and_compare_with_rgb_strip_contig_32.tif",
             view(img_strip), info);
  read_image(tiff_out + "write_tile_and_compare_with_rgb_strip_contig_32.tif",
             img_saved, tag_t());
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  write_view(tiff_out + "write_tile_and_compare_with_rgb_strip_contig_64.tif",
             view(img_strip), info);
  read_image(tiff_out + "write_tile_and_compare_with_rgb_strip_contig_64.tif",
             img_saved, tag_t());
