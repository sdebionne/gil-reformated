...
void test_read_image_info_using_string() {
  ...
  }
  {
    ...
    using backend_t =
        gil::get_reader_backend<std::ifstream, gil::png_tag>::type;
...
void test_write_view() {
  ...
  }
  {
    ...
    gil::write_view(filename,
                    create_mandel_view(320, 240, gil::bgr8_pixel_t(255, 0, 0),
                                       gil::bgr8_pixel_t(0, 255, 0)),
                    gil::png_tag());
  }
  {
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  gil::write_view(png_out + "dynamic_image_test.png", gil::view(image),
                  gil::png_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
}
