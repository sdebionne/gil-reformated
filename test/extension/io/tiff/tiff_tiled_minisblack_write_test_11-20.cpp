...
BOOST_PP_REPEAT_FROM_TO(11, 16, GENERATE_WRITE_TILE_BIT_ALIGNED_MINISBLACK,
                        minisblack)
BOOST_PP_REPEAT_FROM_TO(17, 21, GENERATE_WRITE_TILE_BIT_ALIGNED_MINISBLACK,
                        minisblack)
...
void test_write_minisblack_tile_and_compare_with_16() {
  ...
  gil::write_view(tiff_out + "write_minisblack_tile_and_compare_with_16.tif",
                  gil::view(img_strip), info);
  gil::read_image(tiff_out + "write_minisblack_tile_and_compare_with_16.tif",
                  img_saved, gil::tiff_tag());

  BOOST_TEST_EQ(
      gil::equal_pixels(gil::const_view(img_strip), gil::const_view(img_saved)),
      true);
