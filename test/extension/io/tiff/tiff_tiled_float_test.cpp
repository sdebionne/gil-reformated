...
void test_read_minisblack_float_tile_and_strip32() {
  std::string filename_strip(tiff_in_GM +
  ...
  BOOST_TEST(
      gil::equal_pixels(gil::const_view(img_strip), gil::const_view(img_tile)));
}
...
void test_read_minisblack_float_tile_and_strip64() {
  ...
  // FIXME: boost/gil/extension/io/tiff/detail/is_allowed.hpp:229:49: error:
  // ambiguous partial specializations of 'Format_Type
