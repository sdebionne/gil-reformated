...
#define GENERATE_WRITE_TILE_BIT_ALIGNED_RGB(z, n, data)                        \
  void BOOST_PP_CAT(                                                           \
      BOOST_PP_CAT(                                                            \
          BOOST_PP_CAT(BOOST_PP_CAT(write_rgb_tile_and_compare_with_, data),   \
                       _strip_),                                               \
          n),                                                                  \
      bit_bit_aligned)() {                                                     \
    namespace gil = boost::gil;                                                \
    std::string filename(std::string("tiger-") +                               \
                         BOOST_PP_STRINGIZE(data) + "-strip-contig-");         \
...
#define GENERATE_WRITE_TILE_BIT_ALIGNED_MINISBLACK(z, n, data)                 \
  void BOOST_PP_CAT(                                                           \
      BOOST_PP_CAT(                                                            \
          BOOST_PP_CAT(                                                        \
              BOOST_PP_CAT(write_minisblack_tile_and_compare_with_, data),     \
              _strip_),                                                        \
          n),                                                                  \
      bit_bit_aligned)() {                                                     \
    namespace gil = boost::gil;                                                \
...
#define GENERATE_WRITE_TILE_BIT_ALIGNED_PALETTE(z, n, data)                    \
  void BOOST_PP_CAT(                                                           \
      BOOST_PP_CAT(                                                            \
          BOOST_PP_CAT(                                                        \
              BOOST_PP_CAT(write_palette_tile_and_compare_with_, data),        \
              _strip_),                                                        \
          n),                                                                  \
      bit)() {                                                                 \
    namespace gil = boost::gil;                                                \
