...
void test_read_info_tile_minisblack_float() {
  ...
  backend_t backend = gil::read_image_info(
      tiff_in_GM + "tiger-minisblack-float-tile-16.tif", gil::tiff_tag());
...
void test_read_info_tile_minisblack() {
  using backend_t =
      gil::get_reader_backend<std::string const, gil::tiff_tag>::type;
  backend_t backend = gil::read_image_info(
      tiff_in_GM + "tiger-minisblack-tile-08.tif", gil::tiff_tag());
...
void test_read_info_tile_palette() {
  using backend_t =
      gil::get_reader_backend<std::string const, gil::tiff_tag>::type;
  backend_t backend = gil::read_image_info(
      tiff_in_GM + "tiger-palette-tile-08.tif", gil::tiff_tag());
...
void test_read_info_tile_rgb() {
  using backend_t =
      gil::get_reader_backend<std::string const, gil::tiff_tag>::type;
  backend_t backend = gil::read_image_info(
      tiff_in_GM + "tiger-rgb-tile-contig-08.tif", gil::tiff_tag());
...
void test_read_info_tile_planar() {
  using backend_t =
      gil::get_reader_backend<std::string const, gil::tiff_tag>::type;
  backend_t backend = gil::read_image_info(
      tiff_in_GM + "tiger-rgb-tile-planar-08.tif", gil::tiff_tag());
