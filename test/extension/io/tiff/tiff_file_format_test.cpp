...
template <typename Image> void test_tiff_scanline_reader(std::string filename) {
...
void test_four_bit_contiguous_rgb_image() {
  ...
  using image_t =
      gil::bit_aligned_image3_type<4, 4, 4, gil::rgb_layout_t>::type;
  image_t img;
  gil::read_image(filename, img, gil::tiff_tag());
...
void test_ten_bit_contiguous_rgb_image() {
  ...
  using image_t =
      gil::bit_aligned_image3_type<10, 10, 10, gil::rgb_layout_t>::type;
  image_t img;
  gil::read_image(filename, img, gil::tiff_tag());
...
void test_twelve_bit_contiguous_rgb_image() {
  ...
  using image_t =
      gil::bit_aligned_image3_type<12, 12, 12, gil::rgb_layout_t>::type;
  image_t img;
  gil::read_image(filename, img, gil::tiff_tag());
...
void test_fourteen_bit_contiguous_rgb_image() {
  ...
  using image_t =
      gil::bit_aligned_image3_type<14, 14, 14, gil::rgb_layout_t>::type;
  image_t img;
  gil::read_image(filename, img, gil::tiff_tag());
...
void test_twenty_four_bit_contiguous_rgb_image() {
  ...
  using image_t =
      gil::bit_aligned_image3_type<24, 24, 24, gil::rgb_layout_t>::type;
  image_t img;
  gil::read_image(filename, img, gil::tiff_tag());
