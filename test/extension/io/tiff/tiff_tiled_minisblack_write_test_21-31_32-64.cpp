...
void test_write_tile_and_compare_with_minisblack_strip_32() {
  ...
  gil::write_view(tiff_out + "write_minisblack_tile_and_compare_with_32.tif",
                  gil::view(img_strip), info);
  gil::read_image(tiff_out + "write_minisblack_tile_and_compare_with_32.tif",
...
void test_write_tile_and_compare_with_minisblack_strip_64() {
  ...
  write_view(tiff_out + "write_minisblack_tile_and_compare_with_64.tif",
             gil::view(img_strip), info);
  gil::read_image(tiff_out + "write_minisblack_tile_and_compare_with_64.tif",
                  img_saved, gil::tiff_tag());
