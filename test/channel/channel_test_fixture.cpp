...
BOOST_AUTO_TEST_CASE_TEMPLATE(channel_minmax_value_integral, Channel,
...
BOOST_AUTO_TEST_CASE_TEMPLATE(channel_minmax_value_float, Channel,
...
BOOST_AUTO_TEST_CASE_TEMPLATE(packed_channels565, BitField,
                              fixture::channel_bitfield_types) {
  static_assert(std::is_integral<BitField>::value,
...
BOOST_AUTO_TEST_CASE_TEMPLATE(packed_dynamic_channels565, BitField,
                              fixture::channel_bitfield_types) {
  static_assert(std::is_integral<BitField>::value,
                "bitfield is not integral type");
