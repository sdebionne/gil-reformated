...
BOOST_AUTO_TEST_CASE(rgb32f_xyz32f_1) {
  ...
  BOOST_TEST_MESSAGE(p32f[0] << " " << p32f[1] << " " << p32f[2] << " -> "
                             << xyz32f[0] << " " << xyz32f[1] << " "
                             << xyz32f[2] << " -> " << p32f_b[0] << " "
                             << p32f_b[1] << " " << p32f_b[2]);
...
BOOST_AUTO_TEST_CASE(xyz32f_rgb32f_1) {
  ...
  BOOST_TEST_MESSAGE(xyz32f[0] << " " << xyz32f[1] << " " << xyz32f[2] << " -> "
                               << p32f[0] << " " << p32f[1] << " " << p32f[2]
                               << " -> " << xyz32f_b[0] << " " << xyz32f_b[1]
                               << " " << xyz32f_b[2]);
...
BOOST_AUTO_TEST_CASE(rgb8u_xyz32f_1) {
  ...
  BOOST_TEST_MESSAGE(
      ...
      << " " << static_cast<int>(p8u[1]) << " " << static_cast<int>(p8u[2])
...
BOOST_AUTO_TEST_CASE(rgb16u_xyz32f_1) {
  ...
  BOOST_TEST_MESSAGE(
      ...
      << " " << static_cast<int>(p16u[1]) << " " << static_cast<int>(p16u[2])
      << " -> " << xyz32f[0] << " " << xyz32f[1] << " " << xyz32f[2] << " -> "
      << static_cast<int>(p16u_b[0]) << " " << static_cast<int>(p16u_b[1])
