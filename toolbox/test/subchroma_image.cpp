...
BOOST_AUTO_TEST_CASE(subchroma_image_test) {
...

  {
    ...
    std::size_t image_size =
        (y_width * y_height) +
        (y_width / mpl::at_c<factors_t, 0>::type::value) *
            (y_height / mpl::at_c<factors_t, 1>::type::value) +
        (y_width / mpl::at_c<factors_t, 2>::type::value) *
            (y_height / mpl::at_c<factors_t, 3>::type::value);
