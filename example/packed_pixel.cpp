...
/// represent pixel reference and pixel iterator (packed images use C++
/// reference and C pointer respectively). The alignment parameter in the
/// constructor of bit-aligned images is in bit units. For example, if you want
/// your bit-aligned image to have 4-byte alignment of its rows use alignment of
/// 32, not 4.
///
