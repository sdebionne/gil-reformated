...
int main() {
  ...
  gil::rgb8_image_t transf(
      gil::rgb8_image_t::point_t(gil::view(img).dimensions() * 2));
  gil::fill_pixels(gil::view(transf),
                   gil::rgb8_pixel_t(255, 0, 0)); // the background is red
  ...
  gil::resample_pixels(const_view(img), gil::view(transf), mat,
