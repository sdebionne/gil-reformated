...
///////////////////////
////  NOTE: This sample file uses the numeric extension, which does not come
/// with the Boost distribution. /  You may download it from
/// http://opensource.adobe.com/gil
///////////////////////

/// \file
/// \brief Test file for convolve_rows() and convolve_cols() in the numeric
/// extension \author Lubomir Bourdev and Hailin Jin \date February 27, 2007
...
int main() {
  ...
  float gaussian_1[] = {0.00022923296f, 0.0059770769f, 0.060597949f,
  ...
  */
  ...
  convolve_rows_fixed<rgb32f_pixel_t>(const_view(convolved), kernel,
                                      view(convolved));
  convolve_cols_fixed<rgb32f_pixel_t>(const_view(convolved), kernel,
                                      view(convolved));
