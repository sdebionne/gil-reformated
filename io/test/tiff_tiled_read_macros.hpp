...
#define GENERATE_TILE_STRIP_COMPARISON_BIT_ALIGNED_RGB(z, n, data)             \
  BOOST_AUTO_TEST_CASE(BOOST_PP_CAT(                                           \
    ...
    BOOST_CHECK_EQUAL(                                                         \
        equal_pixels(const_view(img_strip), const_view(img_tile)), true);      \
  }
...
#define GENERATE_TILE_STRIP_COMPARISON_BIT_ALIGNED_MINISBLACK(z, n, data)      \
  BOOST_AUTO_TEST_CASE(BOOST_PP_CAT(                                           \
    ...
    using namespace boost;                                                     \
    using namespace gil;                                                       \
    string filename_strip(tiff_in_GM + "tiger-" +                              \
                          BOOST_PP_STRINGIZE(data) + "-strip-");               \
    string filename_tile(tiff_in_GM + "tiger-" +                               \
