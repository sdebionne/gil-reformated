...
BOOST_AUTO_TEST_CASE(write_test) {
...

  {
    write_view(
        ...
        create_mandel_view(200, 200, gray8_pixel_t(0), gray8_pixel_t(255)),
        tag_t());
  }

  {
    write_view(jpeg_out + "rgb8_test.jpg",
               create_mandel_view(200, 200, rgb8_pixel_t(0, 0, 255),
...

  {
    write_view(jpeg_out + "cmyk8_test.jpg",
               create_mandel_view(200, 200, cmyk8_pixel_t(0, 0, 255, 127),
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(jpeg_out + "fast_dct_write_test.jpg", view(img), info);
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
