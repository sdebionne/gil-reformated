...
// BOOST_PP_REPEAT_FROM_TO(11, 16, GENERATE_WRITE_TILE_BIT_ALIGNED_MINISBLACK,
// minisblack ) BOOST_PP_REPEAT_FROM_TO(17, 21,
// GENERATE_WRITE_TILE_BIT_ALIGNED_MINISBLACK, minisblack )
...
BOOST_AUTO_TEST_CASE(write_minisblack_tile_and_compare_with_16) {
  ...
  write_view(tiff_out + "write_minisblack_tile_and_compare_with_16.tif",
             view(img_strip), info);
  read_image(tiff_out + "write_minisblack_tile_and_compare_with_16.tif",
             img_saved, tag_t());
