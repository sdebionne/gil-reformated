...
// BOOST_PP_REPEAT_FROM_TO(1, 8 , GENERATE_WRITE_TILE_BIT_ALIGNED_MINISBLACK,
// minisblack ) BOOST_PP_REPEAT_FROM_TO(9, 11,
...
BOOST_AUTO_TEST_CASE(write_minisblack_tile_and_compare_with_8) {
  ...
  write_view(tiff_out + "write_minisblack_tile_and_compare_with_8.tif",
             view(img_strip), info);
  read_image(tiff_out + "write_minisblack_tile_and_compare_with_8.tif",
             img_saved, tag_t());
