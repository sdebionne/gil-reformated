...
// {
//   run_subimage_test<rgb8_image_t, tag_t>(raw_filename, point_t(0, 0),
//   point_t(127, 1)); run_subimage_test<rgb8_image_t, tag_t>(raw_filename,
//   point_t(39, 7), point_t(50, 50));
// }
