...
template <typename Image> void test_tiff_scanline_reader(string filename) {
...
BOOST_AUTO_TEST_CASE(two_bit_minisblack_gray_image_test) {
...

  {
    ...
    write_view(tiff_out + "test4.tif", view(img), tiff_tag());
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test5.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test6.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test7.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test8.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test9.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test10.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test11.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test12.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test13.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test14.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test15.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test16.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test17.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test18.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test19.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test20.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test21.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test22.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test23.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test24.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test25.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test26.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test27.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test28.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test29.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test30.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test31.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test32.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test33.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test34.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test35.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test36.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test37.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test38.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test39.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test40.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test41.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test42.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
...
#ifdef BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
    write_view(tiff_out + "test43.tif", view(img), tiff_tag());
#endif // BOOST_GIL_IO_TEST_ALLOW_WRITING_IMAGES
  }
}
