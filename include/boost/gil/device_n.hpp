...
template <>
struct devicen_t<3>
    : public mpl::vector3<devicen_color_t<0>, devicen_color_t<1>,
                          devicen_color_t<2>> {};
...
template <>
struct devicen_t<4>
    : public mpl::vector4<devicen_color_t<0>, devicen_color_t<1>,
                          devicen_color_t<2>, devicen_color_t<3>> {};

/// \brief unnamed color space of five channels
/// \ingroup ColorSpaceModel
template <>
struct devicen_t<5>
    : public mpl::vector5<devicen_color_t<0>, devicen_color_t<1>,
                          devicen_color_t<2>, devicen_color_t<3>,
                          devicen_color_t<4>> {};
...
planar_devicen_view(std::size_t width, std::size_t height, IC c0, IC c1,
  ...
  return
      typename type_from_x_iterator<planar_pixel_iterator<IC, devicen_t<2>>>::
          view_t(width, height, planar_pixel_iterator<IC, devicen_t<2>>(c0, c1),
                 rowsize_in_bytes);
}
...
planar_devicen_view(std::size_t width, std::size_t height, IC c0, IC c1, IC c2,
  ...
  return
      typename type_from_x_iterator<planar_pixel_iterator<IC, devicen_t<3>>>::
          view_t(width, height,
                 planar_pixel_iterator<IC, devicen_t<3>>(c0, c1, c2),
                 rowsize_in_bytes);
}
...
planar_devicen_view(std::size_t width, std::size_t height, IC c0, IC c1, IC c2,
  ...
  return
      typename type_from_x_iterator<planar_pixel_iterator<IC, devicen_t<4>>>::
          view_t(width, height,
                 planar_pixel_iterator<IC, devicen_t<4>>(c0, c1, c2, c3),
                 rowsize_in_bytes);
}
...
planar_devicen_view(std::size_t width, std::size_t height, IC c0, IC c1, IC c2,
  ...
  return
      typename type_from_x_iterator<planar_pixel_iterator<IC, devicen_t<5>>>::
          view_t(width, height,
                 planar_pixel_iterator<IC, devicen_t<5>>(c0, c1, c2, c3, c4),
                 rowsize_in_bytes);
}
