...
BOOST_FORCEINLINE void destruct_range_impl(
    ...
    typename std::enable_if<mp11::mp_or<
        ...
        detail::is_trivially_destructible<
            typename std::iterator_traits<Iterator>::value_type>>::value>::type
        * /* ptr */
    = nullptr) {}
...
using planar_to_planar_type =
    std::integral_constant<copy_planarity_condition,
...
/// std::uninitialized_copy for interleaved or mixed(planar into interleaved)
/// iterators
template <typename It1, typename It2>
BOOST_FORCEINLINE void uninitialized_copy_aux(It1 first1, It1 last1, It2 first2,
                                              It2 last2,
    ...
    try {
      for (y = 0; y < view1.height(); ++y)
        detail::uninitialized_copy_aux(view1.row_begin(y), view1.row_end(y),
                                       view2.row_begin(y), view2.row_end(y),
                                       copy_planarity_condition_type());
    } catch (...) {
