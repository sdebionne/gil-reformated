...
/// lookup. \code concept
/// PixelDereferenceAdaptorConcept<boost::UnaryFunctionConcept D>
...
template <typename D> struct PixelDereferenceAdaptorConcept {
  void constraints() {
    ...
    gil_function_requires<
        PixelConcept<typename detail::remove_const_and_reference<
            typename D::result_type>::type>>();
    ...
    // TODO: Should this be concept-checked after "if you remove const and
    // reference"? --mloskot
    using reference = typename D::reference; // == PixelConcept (if you remove
                                             // const and reference)
    using const_reference =
        typename D::const_reference; // == PixelConcept (if you remove const and
                                     // reference)
