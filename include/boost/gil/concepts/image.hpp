...
///     Image::Image(point_t dims, value_type fill_value, std::size_t
///     alignment);
///
///     void Image::recreate(point_t new_dims, std::size_t alignment=1);
///     void Image::recreate(point_t new_dims, value_type fill_value,
...
///
///     Image::Image(x_coord_t width, y_coord_t height, std::size_t
///     alignment=1); Image::Image(x_coord_t width, y_coord_t height, value_type
///     fill_value, std::size_t alignment);
///
///     x_coord_t Image::width() const;
///     y_coord_t Image::height() const;
///
///     void Image::recreate(x_coord_t width, y_coord_t height, std::size_t
///     alignment=1); void Image::recreate(x_coord_t width, y_coord_t height,
///     value_type fill_value, std::size_t alignment);
/// };
/// \endcode
template <typename Image> struct RandomAccess2DImageConcept {
  void constraints() {
...
/// };
/// \endcode
template <typename Image> struct ImageConcept {
  void constraints() {
    ...
    static_assert(num_channels<Image>::value ==
                      mpl::size<typename color_space_type<Image>::type>::value,
                  "");
