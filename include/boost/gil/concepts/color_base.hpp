...
template <typename ColorBase> struct ColorBaseConcept {
  void constraints() {
    ...
    // TODO: channel_mapping_t must be an Boost.MP11-compatible random access
    // sequence
...
///     kth_element_const_reference_type<CB,0>::type dynamic_at_c(CB const&,
///     std::size_t n) const;
/// };
/// \endcode
...
struct ColorBasesCompatibleConcept {
  void constraints() {
    static_assert(
        std::is_same<typename ColorBase1::layout_t::color_space_t,
