...
/// {
///     typename value_type      = T;        // use
///     channel_traits<T>::value_type to access it typename reference       =
///     T&;       // use channel_traits<T>::reference to access it typename
///     pointer         = T*;       // use channel_traits<T>::pointer to access
///     it typename const_reference = const T&; // use
///     channel_traits<T>::const_reference to access it typename const_pointer
///     = const T*; // use channel_traits<T>::const_pointer to access it static
///     const bool is_mutable;        // use channel_traits<T>::is_mutable to
///     access it
///
...
/// Swappable<T> {}; \endcode \ingroup ChannelConcept
...
///
/// concept ChannelConvertibleConcept<ChannelConcept SrcChannel,
/// ChannelValueConcept DstChannel>
/// {
