...
/// {
///     P::template element_const_reference_type<P>::type operator[](P p,
///     std::size_t i) const
///     {
...
/// {
///     P::template element_reference_type<P>::type operator[](P p, std::size_t
///     i)
///     {
///         return dynamic_at_c(p, i);
///     }
...
/// Pixels are compatible if their channels and color space types are
/// compatible. Compatible pixels can be assigned and copy constructed from one
/// another. \tparam P1 Models PixelConcept \tparam P2 Models PixelConcept \code
