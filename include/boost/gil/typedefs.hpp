...
#define GIL_DEFINE_BASE_TYPEDEFS_INTERNAL(T, CS, LAYOUT)                       \
  ...
  typedef byte_addressable_2d_locator<                                         \
      byte_addressable_step_iterator<CS##T##_ptr_t>>                           \
      CS##T##_loc_t;                                                           \
  typedef byte_addressable_2d_locator<                                         \
      byte_addressable_step_iterator<CS##T##c_ptr_t>>                          \
      CS##T##c_loc_t;                                                          \
  typedef byte_addressable_2d_locator<                                         \
      byte_addressable_step_iterator<CS##T##_step_ptr_t>>                      \
      CS##T##_step_loc_t;                                                      \
  typedef byte_addressable_2d_locator<                                         \
      byte_addressable_step_iterator<CS##T##c_step_ptr_t>>                     \
      CS##T##c_step_loc_t;                                                     \
...
#define GIL_DEFINE_ALL_TYPEDEFS_INTERNAL(T, CS, CS_FULL, LAYOUT)               \
  ...
  typedef planar_pixel_iterator<const bits##T *, CS_FULL>                      \
      CS##T##c_planar_ptr_t;                                                   \
  typedef byte_addressable_step_iterator<CS##T##_planar_ptr_t>                 \
      CS##T##_planar_step_ptr_t;                                               \
  typedef byte_addressable_step_iterator<CS##T##c_planar_ptr_t>                \
      CS##T##c_planar_step_ptr_t;                                              \
  typedef byte_addressable_2d_locator<                                         \
      byte_addressable_step_iterator<CS##T##_planar_ptr_t>>                    \
      CS##T##_planar_loc_t;                                                    \
  typedef byte_addressable_2d_locator<                                         \
      byte_addressable_step_iterator<CS##T##c_planar_ptr_t>>                   \
      CS##T##c_planar_loc_t;                                                   \
  typedef byte_addressable_2d_locator<                                         \
      byte_addressable_step_iterator<CS##T##_planar_step_ptr_t>>               \
      CS##T##_planar_step_loc_t;                                               \
  typedef byte_addressable_2d_locator<                                         \
      byte_addressable_step_iterator<CS##T##c_planar_step_ptr_t>>              \
