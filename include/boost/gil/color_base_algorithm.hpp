...
\brief Returns an integral constant type specifying the number of elements in a
color base
...
/// \brief Returns an integral constant type specifying the number of elements
/// in a color base \ingroup ColorBaseAlgorithmSize
...
mp11::mp_list_c<unsigned,4,3,2>, bgr_layout_t>::type;
...
template <typename ColorBase, int K> struct kth_semantic_element_type {
  ...
  static constexpr int semantic_index =
      mp11::mp_at_c<channel_mapping_t, K>::type::value;
...
template <typename P>
BOOST_FORCEINLINE typename element_const_reference_type<P>::type
...
///
/// Example: Set each channel of a pixel to its semantic index. The channels
/// must be assignable from an integer. \code struct consecutive_fn {
///     int& _current;
...
///
/// Example: Write a generic function that adds two pixels into a homogeneous
/// result pixel. \code template <typename Result> struct my_plus {
...
template <typename P2, typename P3, typename Dst, typename Op>
BOOST_FORCEINLINE Op static_transform(const P2 &p2, const P3 &p3, Dst &dst,
                                      Op op) {
  return detail::element_recursion<size<Dst>::value>::static_transform(p2, p3,
                                                                       dst, op);
}
...
template <typename P1, typename P2, typename P3, typename Op>
BOOST_FORCEINLINE Op static_for_each(P1 &p1, const P2 &p2, const P3 &p3,
                                     Op op) {
  return detail::element_recursion<size<P1>::value>::static_for_each(p1, p2, p3,
                                                                     op);
}
...
template <typename P1, typename P2, typename P3, typename Op>
BOOST_FORCEINLINE Op static_for_each(const P1 &p1, P2 &p2, const P3 &p3,
                                     Op op) {
  return detail::element_recursion<size<P1>::value>::static_for_each(p1, p2, p3,
                                                                     op);
}
template <typename P1, typename P2, typename P3, typename Op>
BOOST_FORCEINLINE Op static_for_each(const P1 &p1, const P2 &p2, P3 &p3,
                                     Op op) {
  return detail::element_recursion<size<P1>::value>::static_for_each(p1, p2, p3,
                                                                     op);
}
template <typename P1, typename P2, typename P3, typename Op>
BOOST_FORCEINLINE Op static_for_each(const P1 &p1, const P2 &p2, const P3 &p3,
                                     Op op) {
  return detail::element_recursion<size<P1>::value>::static_for_each(p1, p2, p3,
                                                                     op);
}
