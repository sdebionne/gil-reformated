...
// A mutable reference to a 6-bit BGR pixel in "123" format (1 bit for red, 2
bits for green, 3 bits for blue) using rgb123_ref_t =
...
template <typename BitField,
          typename ChannelBitSizes, // MPL integral vector defining the number
                                    // of bits for each channel. For example,
                                    // for 565RGB, vector_c<int,5,6,5>
