...
/// non-word memory boundary, unaligned access may result in performance
/// improvement. \warning Unfortunately, this optimization may be a C/C++ strict
/// aliasing rules violation, if accessed data buffer has effective type that
/// cannot be aliased without leading to undefined behaviour.
