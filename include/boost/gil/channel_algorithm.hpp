...
#pragma warning(push)
#pragma warning(                                                               \
    disable : 4309) // disable truncation of constant value warning (using -1 to
                    // get the max value of an integral)
#endif

namespace detail {

// some forward declarations
template <typename SrcChannelV, typename DstChannelV, bool SrcIsIntegral,
          bool DstIsIntegral>
...
/// returns its maximum value as an MPL integral constant
//////////////////////////////////////

template <typename UnsignedIntegralChannel>
struct unsigned_integral_max_value
    : public mpl::integral_c<UnsignedIntegralChannel, -1> {};
...
struct unsigned_integral_num_bits
    : public mpl::int_<sizeof(UnsignedIntegralChannel) * 8> {};
...
detail::channel_convert_to_unsigned and \p detail::channel_convert_from_unsigned
...
struct channel_converter_unsigned
    : public detail::channel_converter_unsigned_impl<
          SrcChannelV, DstChannelV, is_integral<SrcChannelV>::value,
          is_integral<DstChannelV>::value> {};
...
struct channel_converter_unsigned_impl
  ...
  DstChannelV operator()(SrcChannelV src) const {
    return DstChannelV(channel_traits<DstChannelV>::min_value() +
                       (src - channel_traits<SrcChannelV>::min_value()) /
                           channel_range<SrcChannelV>() *
...
// When both the source and the destination are integral channels, perform a
// faster conversion
...
struct channel_converter_unsigned_impl<SrcChannelV, DstChannelV, true, true>
    : public channel_converter_unsigned_integral<
          ...
          mpl::less<unsigned_integral_max_value<SrcChannelV>,
...
template <typename SrcChannelV, typename DstChannelV>
struct channel_converter_unsigned_integral_impl<SrcChannelV, DstChannelV, true,
                                                true> {
  DstChannelV operator()(SrcChannelV src) const {
    typedef
        typename unsigned_integral_max_value<DstChannelV>::value_type integer_t;
...
template <typename SrcChannelV, typename DstChannelV>
struct channel_converter_unsigned_integral_impl<SrcChannelV, DstChannelV, false,
                                                true> {
  DstChannelV operator()(SrcChannelV src) const {
    typedef
...
struct channel_converter_unsigned_integral_impl<uintmax_t, DstChannelV, false,
                                                true> {
...
// See if you can represent the expression (src * dst_max) / src_max in integral
// form
template <typename SrcChannelV, typename DstChannelV, bool SrcLessThanDst>
struct channel_converter_unsigned_integral_impl<SrcChannelV, DstChannelV,
                                                SrcLessThanDst, false>
    : public channel_converter_unsigned_integral_nondivisible<
          SrcChannelV, DstChannelV, SrcLessThanDst,
          mpl::greater<mpl::plus<unsigned_integral_num_bits<SrcChannelV>,
...
struct channel_converter_unsigned_integral_nondivisible<
  ...
  DstChannelV operator()(SrcChannelV src) const {
    typedef typename detail::min_fast_uint<
        ...
        unsigned_integral_num_bits<DstChannelV>::value>::type integer_t;
    return DstChannelV(
        integer_t(src * unsigned_integral_max_value<DstChannelV>::value) /
        unsigned_integral_max_value<SrcChannelV>::value);
  }
};
...
// the src max value is less than the dst max value,
// and the dst max value is not divisible by the src max value
// The expression (src * dst_max) / src_max cannot fit in an integer
// (overflows). Use a double
template <typename SrcChannelV, typename DstChannelV>
struct channel_converter_unsigned_integral_nondivisible<
...
struct channel_converter_unsigned<SrcChannelV, bits32f>
    : public std::unary_function<SrcChannelV, bits32f> {
  bits32f operator()(SrcChannelV x) const {
    return bits32f(x / float(channel_traits<SrcChannelV>::max_value()));
  }
};
