...
inline typename get_writer<String, FormatTag>::type make_writer(
...
inline typename get_writer<std::wstring, FormatTag>::type
...
inline typename get_writer<Device, FormatTag>::type make_writer(
...
template <typename FormatTag>
inline typename get_writer<std::wstring, FormatTag>::type
make_writer(const std::wstring &file_name, const FormatTag &) {
  return make_writer(file_name, image_write_info<FormatTag>());
}
...
template <typename FormatTag>
inline typename get_writer<std::wstring, FormatTag>::type
make_writer(const filesystem::path &path, const FormatTag &tag) {
