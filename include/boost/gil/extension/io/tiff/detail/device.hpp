...
template <> struct get_property_f<2> {
  ...
  bool call_me(typename Property::type &vs, std::shared_ptr<TIFF> &file) const {
    mp11::mp_at<typename Property::arg_types, std::integral_constant<int, 0>>
        length;
    mp11::mp_at<typename Property::arg_types, std::integral_constant<int, 1>>
        pointer;
    if (1 ==
...
template <>
struct sample_format<uint16_t>
    : std::integral_constant<int, SAMPLEFORMAT_UINT> {};
template <>
struct sample_format<uint32_t>
    : std::integral_constant<int, SAMPLEFORMAT_UINT> {};
template <>
struct sample_format<float32_t>
    : std::integral_constant<int, SAMPLEFORMAT_IEEEFP> {};
template <>
struct sample_format<double>
    : std::integral_constant<int, SAMPLEFORMAT_IEEEFP> {};
template <>
