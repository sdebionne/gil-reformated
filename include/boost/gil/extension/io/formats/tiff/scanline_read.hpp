...
class scanline_reader<Device, tiff_tag>
    : public reader_backend<Device, tiff_tag> {
private:
  typedef scanline_reader<Device, tiff_tag> this_t;
...
public:
  ...
  void read(byte_t *dst, int pos) { _read_function(this, dst, pos); }

  /// Skip over a scanline.
  void skip(byte_t *dst, int pos) { this->_read_function(this, dst, pos); }
...
private:
  void initialize() {
    ...
    if (this->_info._photometric_interpretation == PHOTOMETRIC_PALETTE) {
      ...
      case 1: {
        typedef channel_type<get_pixel_type<gray1_image_t::view_t>::type>::type
            channel_t;
      ...
      case 2: {
        typedef channel_type<get_pixel_type<gray2_image_t::view_t>::type>::type
            channel_t;
      ...
      case 4: {
        typedef channel_type<get_pixel_type<gray4_image_t::view_t>::type>::type
            channel_t;
      ...
      case 8: {
        typedef channel_type<get_pixel_type<gray8_image_t::view_t>::type>::type
            channel_t;
      ...
      case 16: {
        typedef channel_type<get_pixel_type<gray16_image_t::view_t>::type>::type
            channel_t;
      ...
      case 24: {
        typedef channel_type<get_pixel_type<gray24_image_t::view_t>::type>::type
            channel_t;
      ...
      case 32: {
        typedef channel_type<get_pixel_type<gray32_image_t::view_t>::type>::type
            channel_t;
      ...
      if (this->_info._planar_configuration == PLANARCONFIG_SEPARATE) {
        ...
        // the read_data function needs to know what gil type the source image
        // is to have the default color converter function correctly
  ...
  template <typename Src_View> void read_n_bits_row(byte_t *dst, int pos) {
    ...
    dst_view_t dst_view = interleaved_view(
        this->_info._width, 1, (typename dst_view_t::value_type *)dst,
