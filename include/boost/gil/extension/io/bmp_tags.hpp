...
/// See http://en.wikipedia.org/wiki/BMP_file_format#BMP_File_Header for
/// reference.
...
struct bmp_header_size : property_base<uint32_t> {
  ...
  static const type _win32_info_size =
      40; /// Constant size for win32 bmp info header size.
  static const type _os2_info_size =
      12; /// Constant size for os2 bmp info header size.
};
...
static const uint32_t bmp_signature =
    0x4D42; /// Constant signature for bmp file format.

/// Read information for bmp images.
///
/// The structure is returned when using read_image_info.
template <> struct image_read_info<bmp_tag> {
  /// Default contructor.
  image_read_info<bmp_tag>() : _valid(false) {}
  ...
  /// The compression method being used. See above for a list of possible
  /// values.
...
template <> struct image_write_info<bmp_tag> {};
