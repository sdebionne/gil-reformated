...
template <> struct image_read_info<targa_tag> {
  /// Default contructor.
  image_read_info<targa_tag>() : _valid(false) {}

  /// The size of this header:
  targa_header_size::type _header_size;

  /// The offset, i.e. starting address, of the byte where the targa data can be
  /// found.
...
template <> struct image_write_info<targa_tag> {};
