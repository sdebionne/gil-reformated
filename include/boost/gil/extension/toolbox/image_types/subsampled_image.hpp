...
template <typename Locator> struct subsampled_image_deref_fn {
  ...
  /// constructor
  subsampled_image_deref_fn(const Locator &y_locator, const Locator &v_locator,
...
public:
  ...
  subsampled_image(const x_coord_t y_width, const y_coord_t y_height,
                   const x_coord_t v_width, const y_coord_t v_height,
                   const x_coord_t u_width, const y_coord_t u_height,
    ...
    init(point_t(y_width, y_height), point_t(v_width, v_height),
...
private:
  void init(const point_t &y_dimensions, const point_t &v_dimensions,
    ...
    _view = view_t(y_dimensions, v_dimensions, u_dimensions, locator);
  }
