...
public:
  ...
  typedef
      typename subsampled_image_locator<typename pixel_view_t::locator>::type
          locator_t;
  ...
  subsampled_image(const x_coord_t y_width, const y_coord_t y_height,
      ...
      : _y_plane(y_width, y_height, 0, Allocator()),
        ...
        _u_plane(y_width / ux_ssfactor, y_height / uy_ssfactor, 0,
                 Allocator()) {
    init(point_t(y_width, y_height), vx_ssfactor, vy_ssfactor, ux_ssfactor,
         uy_ssfactor);
  }
...
/////////////////////////////////////////////////////////////////////////////////////////
// template< typename Pixel >
// typename subsampled_image< Pixel >::view_t subsampled_view( std::size_t
// y_width
//                                                          , std::size_t
//                                                          y_height , unsigned
//                                                          char* y_base ,
...
//    unsigned char* v_base = u_base + ( y_width / ux_ssfactor ) * ( y_height /
//    uy_ssfactor ) * u_channel_size;
//
...
//                                           , (plane_view_t::value_type*)
//                                           u_base // pixels , y_width //
//                                           rowsize_in_bytes
//                                           );
//
//    typedef subsampled_image_deref_fn< subsampled_image< Pixel >::locator_t >
//    defer_fn_t; defer_fn_t deref_fn( y_plane.xy_at( 0, 0 )
//                       , v_plane.xy_at( 0, 0 )
//                       , u_plane.xy_at( 0, 0 )
//                       , vx_ssfactor
//                       , vy_ssfactor
