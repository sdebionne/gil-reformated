...
BOOST_FORCEINLINE auto apply_operation(variant2::variant<Types...> &arg,
                                       UnaryOp op)
...
/// object) on a variant
template <typename... Types, typename UnaryOp>
BOOST_FORCEINLINE auto apply_operation(variant2::variant<Types...> const &arg,
                                       UnaryOp op)
#if defined(BOOST_NO_CXX14_DECLTYPE_AUTO) ||                                   \
    defined(BOOST_NO_CXX11_DECLTYPE_N3276)
    -> typename UnaryOp::result_type
...
BOOST_FORCEINLINE auto apply_operation(variant2::variant<Types1...> const &arg1,
