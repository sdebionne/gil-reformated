...
template <typename View> using get_const_t = typename View::const_t;
...
/// \brief Represents a run-time specified image view. Models
/// HasDynamicXStepTypeConcept, HasDynamicYStepTypeConcept, Note that this class
/// does NOT model ImageViewConcept
///
