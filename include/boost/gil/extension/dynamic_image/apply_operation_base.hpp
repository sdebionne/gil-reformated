...
UnaryOp op) const { using T0 = typename mpl::begin<Types>::type; using T1 =
typename mpl::next<T0>::type; using T2 = typename mpl::next<T1>::type; switch
...
index, UnaryOp op) const { using T0 = typename mpl::begin<Types>::type; using T1
= typename mpl::next<T0>::type; using T2 = typename mpl::next<T1>::type; switch
