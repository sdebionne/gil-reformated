...
template <typename Result> struct subimage_view_fn {
  typedef Result result_type;
  subimage_view_fn(const point2<std::ptrdiff_t> &topleft,
...
template <typename DstP, typename Result, typename CC = default_color_converter>
...
inline // Models MPL Random Access Container of models of ImageViewConcept
  ...
  return apply_operation(
      src,
      detail::flipped_up_down_view_fn<
          typename dynamic_y_step_type<any_image_view<ViewTypes>>::type>());
}
...
inline // Models MPL Random Access Container of models of ImageViewConcept
  ...
  return apply_operation(
      src,
      detail::flipped_left_right_view_fn<
          typename dynamic_x_step_type<any_image_view<ViewTypes>>::type>());
}
...
inline // Models MPL Random Access Container of models of ImageViewConcept
  ...
  return apply_operation(
      src, detail::tranposed_view_fn<typename dynamic_xy_step_transposed_type<
...
inline // Models MPL Random Access Container of models of ImageViewConcept
  ...
  return apply_operation(
      src, detail::rotated90cw_view_fn<typename dynamic_xy_step_transposed_type<
               any_image_view<ViewTypes>>::type>());
}
...
inline // Models MPL Random Access Container of models of ImageViewConcept
    ...
    subimage_view(const any_image_view<ViewTypes> &src,
                  const point2<std::ptrdiff_t> &topleft,
                  const point2<std::ptrdiff_t> &dimensions) {
  return apply_operation(
      src,
      detail::subimage_view_fn<any_image_view<ViewTypes>>(topleft, dimensions));
}
...
inline // Models MPL Random Access Container of models of ImageViewConcept
    any_image_view<ViewTypes>
    subimage_view(const any_image_view<ViewTypes> &src, int xMin, int yMin,
                  int width, int height) {
  return apply_operation(src,
                         detail::subimage_view_fn<any_image_view<ViewTypes>>(
                             point2<std::ptrdiff_t>(xMin, yMin),
                             point2<std::ptrdiff_t>(width, height)));
}
...
inline // Models MPL Random Access Container of models of ImageViewConcept
    typename dynamic_xy_step_type<any_image_view<ViewTypes>>::type
    subsampled_view(const any_image_view<ViewTypes> &src,
                    const point2<std::ptrdiff_t> &step) {
  return apply_operation(
      src, detail::subsampled_view_fn<
               typename dynamic_xy_step_type<any_image_view<ViewTypes>>::type>(
               step));
}
...
inline // Models MPL Random Access Container of models of ImageViewConcept
    typename dynamic_xy_step_type<any_image_view<ViewTypes>>::type
    subsampled_view(const any_image_view<ViewTypes> &src, int xStep,
                    int yStep) {
  return apply_operation(
      src, detail::subsampled_view_fn<
               typename dynamic_xy_step_type<any_image_view<ViewTypes>>::type>(
               point2<std::ptrdiff_t>(xStep, yStep)));
}
...
struct nth_channel_view_type<any_image_view<ViewTypes>> {
  typedef any_image_view<
      typename detail::views_get_nthchannel_type<ViewTypes>::type>
      type;
};
...
template <typename ViewTypes>
inline // Models MPL Random Access Container of models of ImageViewConcept
    typename nth_channel_view_type<any_image_view<ViewTypes>>::type
    nth_channel_view(const any_image_view<ViewTypes> &src, int n) {
  return apply_operation(
      src,
      detail::nth_channel_view_fn<
          typename nth_channel_view_type<any_image_view<ViewTypes>>::type>(n));
}

namespace detail {
template <typename View, typename DstP, typename CC>
struct get_ccv_type : public color_converted_view_type<View, DstP, CC> {};
...
struct color_converted_view_type<any_image_view<ViewTypes>, DstP, CC> {
  typedef any_image_view<
      typename detail::views_get_ccv_type<ViewTypes, DstP, CC>::type>
      type;
};
...
inline // Models MPL Random Access Container of models of ImageViewConcept
  ...
  return apply_operation(
      ...
      detail::color_converted_view_fn<
          DstP, typename color_converted_view_type<any_image_view<ViewTypes>,
                                                   DstP, CC>::type>());
}
...
struct color_converted_view_type<any_image_view<ViewTypes>, DstP> {
  typedef any_image_view<typename detail::views_get_ccv_type<
      ViewTypes, DstP, default_color_converter>::type>
      type;
};
...
inline // Models MPL Random Access Container of models of ImageViewConcept
    typename color_converted_view_type<any_image_view<ViewTypes>, DstP>::type
