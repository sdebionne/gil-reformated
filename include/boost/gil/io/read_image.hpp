...
/// \param img       The image in which the data is read into. Must satisfy
/// is_read_supported metafunction. \throw std::ios_base::failure
...
/// \param img       The image in which the data is read into. Must satisfy
/// is_read_supported metafunction. \param settings  Specifies read settings
...
/// \param file      It's a device. Must satisfy is_input_device metafunction.
/// \param img       The image in which the data is read into. Must satisfy
/// is_read_supported metafunction. \param tag       Defines the image format.
...
/// Must satisfy is_read_supported metafunction. \param settings  Specifies read
...
/// \param file_name File name. Must satisfy is_supported_path_spec
/// metafunction. \param img       The image in which the data is read into.
/// Must satisfy is_read_supported metafunction. \param tag       Defines the
/// image format. Must satisfy is_format_tag metafunction. \throw
