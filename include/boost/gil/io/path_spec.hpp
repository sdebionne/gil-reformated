...
// Disable warning: conversion to 'std::atomic<int>::__integral_type {aka int}'
...
inline std::string convert_to_string(std::string const &obj) { return obj; }
...
inline std::string convert_to_string(char *str) { return std::string(str); }
...
inline const char *convert_to_native_string(char *str) { return str; }

inline const char *convert_to_native_string(const char *str) { return str; }
