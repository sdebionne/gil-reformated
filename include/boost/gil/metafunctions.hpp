...
///    gil::byte_addressable_step_iterator (if step). They must use the standard
///    constness rules.
/// \ingroup GILIsBasic
...
struct iterator_is_basic<byte_addressable_step_iterator<pixel<T, L> *>>
    : public mpl::true_ {};
template <typename T, typename L> // immutable interleaved step
struct iterator_is_basic<byte_addressable_step_iterator<const pixel<T, L> *>>
    : public mpl::true_ {};
template <typename T, typename Cs> // mutable   planar step
struct iterator_is_basic<
    byte_addressable_step_iterator<planar_pixel_iterator<T *, Cs>>>
    : public mpl::true_ {};
template <typename T, typename Cs> // immutable planar step
struct iterator_is_basic<
    byte_addressable_step_iterator<planar_pixel_iterator<const T *, Cs>>>
    : public mpl::true_ {};
...
struct locator_is_basic<
    byte_addressable_2d_locator<byte_addressable_step_iterator<Iterator>>>
...
template <typename T, typename L>
struct pixel_reference_is_mutable<pixel<T, L> &> : public mpl::true_ {};
template <typename T, typename L>
struct pixel_reference_is_mutable<const pixel<T, L> &> : public mpl::false_ {};
template <typename TR, typename Cs>
struct pixel_reference_is_mutable<planar_pixel_reference<TR, Cs>>
    : public mpl::bool_<channel_traits<TR>::is_mutable> {};
template <typename TR, typename Cs>
struct pixel_reference_is_mutable<const planar_pixel_reference<TR, Cs>>
    : public mpl::bool_<channel_traits<TR>::is_mutable> {};
...
/// \brief Determines if the given object is a GIL pixel reference (as opposed
/// to a pixel value or anything else). Custom models of references must provide
/// specializations. \ingroup TypeAnalysis
template <typename R>
struct is_pixel_reference : public pixel_reference_is_basic<R> {};
