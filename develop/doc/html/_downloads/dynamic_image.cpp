...
int main() {
  ...
  using my_images_t = boost::mpl::vector<bg::gray8_image_t, bg::rgb8_image_t,
                                         bg::gray16_image_t, bg::rgb16_image_t>;
  bg::any_image<my_images_t> dynamic_image;
  bg::read_image("test.jpg", dynamic_image, bg::jpeg_tag());
  // Save the image upside down, preserving its native color space and channel
  // depth
